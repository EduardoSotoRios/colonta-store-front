...
import type { Address, ProductModel } from "@/lib/api";
    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="py-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          {/* Mis Pedidos — enlace a la página de seguimiento */}
          <Link
            href="/seguimiento"
            className="flex items-center justify-between rounded-2xl ring-1 ring-black/5 p-6 bg-white hover:bg-slate-50 transition-colors group"
          >
            <div>
              <p className="font-extrabold text-lg text-slate-900">Mis Pedidos</p>
              <p className="text-sm text-slate-500 mt-0.5">Revisa el estado y avance de cada pedido</p>
            </div>
            <svg className="w-5 h-5 text-slate-400 group-hover:text-colonta-primary transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
