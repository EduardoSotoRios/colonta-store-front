    ...
    <main className="min-h-screen">
      <section className="bg-colonta-primary text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <a href="/mochilas" className="text-white/80 hover:text-white">
            &larr; Volver a la tienda
          </a>
          <h1 className="mt-2 text-3xl md:text-4xl font-extrabold">{product.name}</h1>
          <p className="mt-1 text-white/85 capitalize">
            {CATEGORIA_NOMBRES[product.category] ?? product.category}
          </p>
        </div>
      </section>
