export const REGIONES: { value: string; label: string }[] = [
  { value: "Región de Arica y Parinacota",                     label: "Arica y Parinacota" },
  { value: "Región de Tarapacá",                               label: "Tarapacá" },
  { value: "Región de Antofagasta",                            label: "Antofagasta" },
  { value: "Región de Atacama",                                label: "Atacama" },
  { value: "Región de Coquimbo",                               label: "Coquimbo" },
  { value: "Región de Valparaíso",                             label: "Valparaíso" },
  { value: "Región Metropolitana de Santiago",                 label: "Metropolitana de Santiago" },
  { value: "Región del Libertador General Bernardo O'Higgins", label: "O'Higgins" },
  { value: "Región del Maule",                                 label: "Maule" },
  { value: "Región de Ñuble",                                  label: "Ñuble" },
  { value: "Región del Biobío",                                label: "Biobío" },
  { value: "Región de La Araucanía",                           label: "La Araucanía" },
  { value: "Región de Los Ríos",                               label: "Los Ríos" },
  { value: "Región de Los Lagos",                              label: "Los Lagos" },
  { value: "Región de Aysén",                                  label: "Aysén" },
  { value: "Región de Magallanes y la Antártica Chilena",      label: "Magallanes y la Antártica" },
];
...
export const COMUNAS_POR_REGION: Record<string, string[]> = {
  ...
  "Región de Ñuble": [
    ...
    "Coelemu", "Ninhue", "Portezuelo", "Quirihue", "Ránquil", "Treguaco", "Cobquecura",
